...
public class BaseThreadController {
    ...
    // 线程池最大线程数
    protected static int MAX_POOL_SIZE = 100;

    // 额外线程空状态生存时间
    protected static int KEEP_ALIVE_TIME = 10000;
    ...
    public static BaseThreadController getInstance() {
    ...
    private static class InstanceBuilder {
        protected static BaseThreadController instance = new BaseThreadController();
    }
}
