    ...
    private void initEvents() {
        ...
        mListView.setAdapter(new ArrayAdapter<String>(this, -1, mDatas) {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                if (convertView == null) {
                    convertView = LayoutInflater.from(SkinTestActivity.this).inflate(R.layout.item,
                            parent, false);
                }
               ...
               SkinManager.getInstance().changeSkin(mSkinPkgPath,
                        "com.zhy.plugin", new ISkinChangingCallback() {
                            ...
                            public void onError(Exception e) {
                                Toast.makeText(SkinTestActivity.this, "换肤失败", Toast.LENGTH_SHORT)
                                        .show();
                            }

                            @Override
                            public void onComplete() {
                                Toast.makeText(SkinTestActivity.this, "换肤成功", Toast.LENGTH_SHORT)
                                        .show();
                            }
                        });
                break;
